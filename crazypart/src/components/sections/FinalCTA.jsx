        ...
        <section className="py-12 sm:py-16 border-t border-border/60">
            <div className="mx-auto max-w-4xl px-5 sm:px-8 text-center">
                ...
                <div className="mt-8 sm:mt-10 mb-8 text-center">
                    <a
                        href="https://g.page/r/Cdb7aWkxFUNaEAI/review"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-3 bg-foreground hover:bg-foreground/90 text-primary-foreground px-7 py-3.5 rounded-sm text-sm font-medium tracking-wide shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer"
                    >
